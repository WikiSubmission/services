...
export default function listener(): void {
  DiscordBot.shared.addEventListener("messageCreate", async (message) => {
          ...
          components: [
            {
              ...
              options: moderatedGuild.choosableRoles
                ...
                ?.roleNames.map((roleName) => ({
                  label: roleName,
                  value: `Religion:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
                })),
            },
          ],
        },
          ...
          components: [
            {
              ...
              options: moderatedGuild.choosableRoles
                ...
                ?.roleNames.map((roleName) => ({
                  label: roleName,
                  value: `Region:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
          ...
          components: [
            {
              ...
              options: moderatedGuild.choosableRoles
                ...
                ?.roleNames.map((roleName) => ({
                  label: roleName,
                  value: `Age:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
                })),
            },
          ],
        },
          ...
          components: [
            {
              ...
              options: moderatedGuild.choosableRoles
                ...
                ?.roleNames.map((roleName) => ({
                  label: roleName,
                  value: `Marital Status:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
                })),
            },
          ],
        },
    ...
    const reminderRoles = moderatedGuild.choosableRoles
      ...
      ?.roleNames.map((roleName) => ({
        label: roleName,
        value: `Reminders:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
    ...
    const otherLanguageRoles = moderatedGuild.choosableRoles
      ...
      ?.roleNames.map((roleName) => ({
        label: roleName,
        value: `Other Languages:${DiscordBot.shared.client.guilds.cache.find((g) => g.id === moderatedGuild.id)?.roles.cache.find((r) => r.name === roleName)?.id}:${roleName}`,
      }));
